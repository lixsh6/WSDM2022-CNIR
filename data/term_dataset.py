...
class TermDataset(Dataset):
    ...
    def __init__(self,data_addr,cand_term_addr,word2id,ground_truth='PSCM'):
        self.data_addr = data_addr
        self.qfile_list = os.listdir(data_addr)
    ...
    def __getitem__(self, i):
        ...
        query_cand_terms = map(lambda w:find_id(self.word2id,w), self.qid2cand_terms[qid])
        # package data to FloatTensor or cuda()
        #print('==================================')
        return {'qid':qid,'query': query_idx,'raw_query_text':raw_query_text,'raw_docs':raw_docs,\
